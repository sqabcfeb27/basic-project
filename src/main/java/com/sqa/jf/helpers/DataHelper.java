...
/**
 * DataHelper Class to handle reading data from different
 * sources.
 *
...
public class DataHelper {
	...
	/**
	 * Method to read database table with implementation for
	...
	/**
	 * Method to read an excel file in both the old format
	 * of excel and the newer one.
	 *
	 * @param fileLocation
	 * @param fileName
	 * @param hasLabels
	...
	/**
	 * Overloaded method to read text file formatted in CSV
	 * style.
	 *
	 * @param fileName
	 * @return
	...
	/**
	 * Overloaded method to read text file in various format
	 * styles.
	 *
	 * @param fileLocation
	 * @param fileName
	...
	/**
	 * Method to read text file in various format styles and
	 * also allows DataTypes to be specified
	 *
	 * @param fileLocation
	 * @param fileName
	 * @param textFormat
	...
	/**
	 * Overloaded method to read text file in various format
	 * styles and also allows DataTypes to be specified and
	 * also setting no labels.
	 *
	 * @param fileLocation
	 * @param fileName
	 * @param textFormat
	...
	/**
	 * Private method to get data from a new type of Excel
	 * file.
	 *
	 * @param fileLocation
	 * @param fileName
	...
	/**
	 * Private method to get data from an old type of Excel
	 * file.
	 *
	 * @param fileLocation
	 * @param fileName
	...
	/**
	 * Private method to open a text file and collect data
	 * lines as an ArrayList collection of lines.
	 *
	 * @param fileLocation
	 * @param fileName
	 * @return
	...
	/**
	 * Private method to get parse data formatted in CSV
	 * style.
	 *
	 * @param lines
	 * @param hasLabels
	...
	/**
	 * Private method to get parse data formatted in JSON
	 * style.
	 *
	 * @param lines
	 * @param hasLabels
	...
	/**
	 * Private method to get parse data formatted in Tab
	 * style.
	 *
	 * @param lines
	 * @param hasLabels
	...
	/**
	 * Private method to get parse data formatted in XML
	 * style.
	 *
	 * @param lines
	 * @param hasLabels
